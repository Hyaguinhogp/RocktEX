    ...
    return (
        <GameCardContainer url_image={game.url_image}>
            ...
            <div className="game__price-container">
                <h3 className="discount-percent">{calculateDiscountPercent(game.normal_price, game.actual_price)}</h3>
                <div className="prices">
                    <h3 className="normal-price">{formatPrice(game.normal_price)}</h3>
                    <h2 className="actual-price">{formatPrice(game.actual_price)}</h2>
                </div>
            </div>
        </GameCardContainer>
    )
